...
<div class="col-lg-8" >
    <form method="post" action="/dashboard/admin_cafe/katalog/{{ $katalog->id }}" class="mb-5" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('harga') is-invalid @enderror" name="harga" id="harga" required value="{{ old('harga', $katalog->harga) }}">
            @error('harga')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
